...
my_file = open(r"C:\Users\Dell\VS_CODE_PROJECT\Object Detection using yolo model\utils\coco.txt", "r")
# reading the file
data = my_file.read()
...
model = YOLO(r"C:\Users\Dell\VS_CODE_PROJECT\Object Detection using yolo model\yolov8n.pt")
